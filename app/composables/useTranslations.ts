    ...
    pricing: {
      ...
      plans: [
        ...
        },
        {
          ...
          features: ['5 etiquetas de perfil', 'Radio hasta 150 km', 'Hasta 15 etiquetas por oferta', '5 niveles de prioridad', 'Republicar caducadas en un toque', 'Distintivo Premium'],
        },
      ],
    },
    faq: {
    ...
    pricing: {
      ...
      plans: [
        ...
        },
        {
          ...
          features: ['5 profile tags', 'Radius up to 150 km', 'Up to 15 tags per job', '5 priority levels', 'Repost expired jobs in one tap', 'Premium badge'],
        },
      ],
    },
    faq: {
